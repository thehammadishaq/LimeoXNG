  ...
  const renderDescriptiveFilters = () => (
    <div className="filter-grid">
      <div className="filter-item">
        ...
        >
          {filterOptions.exchange.map((opt: string) => (
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.index.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.sector.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.industry.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.country.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.marketCap.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.dividendYield.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.shortFloat.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.analystRecom.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.optionShort.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.earningsDate.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.averageVolume.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.relativeVolume.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.currentVolume.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.price.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.targetPrice.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.ipoDate.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.sharesOutstanding.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
      ...
      <div className="filter-item">
        ...
        >
          {filterOptions.float.map((opt: string) => (
            <option key={opt} value={opt}>{opt}</option>
          ))}
        </select>
      </div>
